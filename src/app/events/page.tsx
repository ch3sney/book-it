  ...
  return (
    <>
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <Button className="rounded-md bg-white">Create event</Button>
      </div>
      <ul className="mt-10">
              ...
              <div className="flex items-center justify-between">
                <div key={event.id} className="flex gap-6 py-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="text-xs/6 text-zinc-600">{event.attendance} expected attendants</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <Badge className="max-sm:hidden" color={event.status === 'Confirmed' ? 'lime' : 'zinc'}>
                    {event.status}
                  </Badge>
                  <Dropdown>
